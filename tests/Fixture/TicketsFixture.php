...
class TicketsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'doc_type' => ['type' => 'integer', 'length' => 1, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'Document_number' => ['type' => 'integer', 'length' => 12, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'output' => ['type' => 'date', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        ...
        '_indexes' => [
            ...
            'reserva_id' => ['type' => 'index', 'columns' => ['reservation_id'], 'length' => []],
            'carro_id' => ['type' => 'index', 'columns' => ['bus_id'], 'length' => []],
        ],
        '_constraints' => [
