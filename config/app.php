...
return [
     ...
     */
    'Security' => [
        'salt' => env('SECURITY_SALT', '0eddfcdb15bc4415818f7d750aa1441a6558ee2255e8603fe09e73346059234d'),
    ],
    ...
    'EmailTransport' => [
        ...
        'gmail'=>[
            ...
            'port'=>465,
            'tiemout'=>30,
            'username'=>'transportesalicuenta@gmail.com',
            'password'=>'Smognews69',
            'client'=>null,
            'tls'=>null,
            'url'=>env('EMAIL_TRANSPORT_DEFAULT_URL',null),
    ...
    'Email' => [
        ...
        'envio' => [
            'transport' => 'gmail',
            'from' => ['transportesalicuenta@gmail.com'=>'Sistema de Login'],
        ],
    ],
